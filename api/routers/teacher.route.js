...
const { registerTeacher, getAllTeacherWithQuery, loginTeacher, updateTeacher, getTeacherOwnData, getTeacherWithId, deleteTeacherWithId } = require('../controllers/teacher.controller');

const router = express.Router();

router.post('/register', authMiddleware(['SCHOOL']), registerTeacher);
router.get('/fetch-with-query', authMiddleware(['SCHOOL']), getAllTeacherWithQuery);
